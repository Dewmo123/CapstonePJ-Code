...
{
    public class PoisonStatusEffect : AbstractStatusEffect
    {
        ...
        public PoisonStatusEffect(Entity target, StatusEffectInfo statusEffectInfo) : base(target, statusEffectInfo)
        {
