...
namespace Scripts.StatusEffects.Effects
{
    public class FlameStatusEffect : AbstractStatusEffect
    {
        ...
        public FlameStatusEffect(Entity target, StatusEffectInfo statusEffectInfo) : base(target,
            statusEffectInfo)
        {
