...
namespace SHS.Scripts.Crosshairs
{
    ...
    public class CrosshairBehavior : MonoBehaviour, IContainerComponent, IAfterInitialze, IAimProvider,
        IDependencyProvider
    {
        [Header("Crosshair Assets")]
        [SerializeField] private CrosshairSO defaultCrosshair;
        ...
        private void UpdateCurrentCrosshairData(bool force = false)
        {
            ...
            Bus.Raise(new ChangeCameraZoom(CurrentCrosshairData != null ? CurrentCrosshairData.cameraFovReduction : 0f));
        }
